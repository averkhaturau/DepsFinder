...
std::list<std::string> INIReader::GetStringList( const std::string& section, const std::string& name, char delimiter )
{
    std::string s = GetString( section, name, "" );
...
std::list<std::filesystem::path> INIReader::GetPathList( const std::string& section, const std::string& name, char delimiter )
{
    std::string s = GetString( section, name, "" );
    std::list<std::filesystem::path> tokens;
    std::string token;
    std::istringstream tokenStream( s );
    while (std::getline( tokenStream, token, delimiter ))
    {
        tokens.push_back( std::filesystem::path(token) );
    }
    return tokens;
}
