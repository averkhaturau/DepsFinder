...
public:
    ...
    std::list<std::string> GetStringList( const std::string& section, const std::string& name, char delimiter = '\n' );

    std::list<std::filesystem::path> GetPathList( const std::string& section, const std::string& name, char delimiter = '\n' );
